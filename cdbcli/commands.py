...
def cd(environment, couch_server, variables):
    ...
    try:
        if not database_name or database_name == '/' or database_name == '..':
            environment.current_db, environment.oldpwd = None, environment.current_db
        elif database_name == '-':
            environment.current_db, environment.oldpwd = environment.oldpwd, environment.current_db
        else:
            environment.current_db, environment.oldpwd = couch_server[database_name], environment.current_db
